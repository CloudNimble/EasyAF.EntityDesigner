...
namespace Microsoft.Data.Entity.Design.Diagrams
{
	...
	internal static partial class AssociationBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
				{
					if (candidateTarget is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
					{
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
				{
					if (target is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
					{
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType sourceAccepted = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)source;
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType targetAccepted = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)target;
						DslModeling::ElementLink result = new global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.Association(sourceAccepted, targetAccepted);
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
				{
					if (candidateTarget is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
					{
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType sourceEntityType = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)candidateSource;
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType targetEntityType = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)candidateTarget;
						if(targetEntityType == null || global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.Inheritance.GetLinkToBaseType(targetEntityType) != null) return false;
						if(targetEntityType == null || sourceEntityType == null || global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.Inheritance.GetLinks(sourceEntityType, targetEntityType).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
				{
					if (target is global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)
					{
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType sourceAccepted = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)source;
						global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType targetAccepted = (global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.EntityType)target;
						DslModeling::ElementLink result = new global::Microsoft.Data.Entity.Design.Diagrams.ViewModel.Inheritance(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
