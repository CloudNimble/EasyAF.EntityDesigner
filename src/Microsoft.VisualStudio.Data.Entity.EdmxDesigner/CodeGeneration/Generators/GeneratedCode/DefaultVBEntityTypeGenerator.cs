...
{
    object value = this.Session["EntitySet"];
    if (typeof(global::System.Data.Entity.Core.Metadata.Edm.EntitySet).IsInstanceOfType(value))
    {
        this._EntitySetField = ((global::System.Data.Entity.Core.Metadata.Edm.EntitySet)(value));
    ...
    else
    {
        if ((value != null))
        {
            global::System.ComponentModel.TypeConverter tc = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(global::System.Data.Entity.Core.Metadata.Edm.EntitySet));
            if (((tc != null) 
                        && tc.CanConvertFrom(value.GetType())))
            {
                this._EntitySetField = ((global::System.Data.Entity.Core.Metadata.Edm.EntitySet)(tc.ConvertFrom(value)));
                EntitySetValueAcquired = true;
            }
            else
            {
                this.Error("The type \'System.Data.Entity.Core.Metadata.Edm.EntitySet\' of the parameter \'Entit" +
                        "ySet\' did not match the type of the data passed to the template.");
            }
        }
    }
}
...
{
    object value = this.Session["Model"];
    if (typeof(global::System.Data.Entity.Infrastructure.DbModel).IsInstanceOfType(value))
    {
        this._ModelField = ((global::System.Data.Entity.Infrastructure.DbModel)(value));
    ...
    else
    {
        if ((value != null))
        {
            global::System.ComponentModel.TypeConverter tc = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(global::System.Data.Entity.Infrastructure.DbModel));
            if (((tc != null) 
                        && tc.CanConvertFrom(value.GetType())))
            {
                this._ModelField = ((global::System.Data.Entity.Infrastructure.DbModel)(tc.ConvertFrom(value)));
                ModelValueAcquired = true;
            }
            else
            {
                this.Error("The type \'System.Data.Entity.Infrastructure.DbModel\' of the parameter \'Model\' did" +
...
{
    object value = this.Session["Namespace"];
    if (typeof(string).IsInstanceOfType(value))
    {
        this._NamespaceField = ((string)(value));
    ...
    else
    {
        if ((value != null))
        {
            ...
            if (((tc != null) 
                        && tc.CanConvertFrom(value.GetType())))
            {
                this._NamespaceField = ((string)(tc.ConvertFrom(value)));
                NamespaceValueAcquired = true;
            }
            else
            {
