        ...
        internal static bool UpdateEdmxAndEnvironment(ModelBuilderSettings settings)
        {
                ...
                && settings.DdlStringReader != null)
            {
                ...
                catch (Exception e)
                {
                    ...
                    VsUtils.ShowErrorDialog(
                        String.Format(
                            CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.VisualStudio.ModelWizard.Properties.Resources.ErrorCouldNotParseDdlFileName, settings.DdlFileName,
                            e.Message));
                    return false;
                }
