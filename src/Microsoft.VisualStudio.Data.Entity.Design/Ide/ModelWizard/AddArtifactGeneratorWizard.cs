...
namespace Microsoft.VisualStudio.Data.Entity.Design.Ide.ModelWizard
{
    ...
    public class AddArtifactGeneratorWizard : IWizard
    {
        ...
        public void ProjectItemFinishedGenerating(ProjectItem projectItem)
        {
            ...
            if (EdmxUri != null)
            {
                var edmxProjectItem = VsUtils.GetProjectItemForDocument(EdmxUri.LocalPath, PackageManager.Package);
            ...
            object automationObject, Dictionary<string, string> replacementsDictionary, WizardRunKind runKind, object[] customParams)
        {
            ...
            else
            {
                ...
                var projectItem = VsUtils.GetProjectItemForDocument(EdmxUri.LocalPath, PackageManager.Package);
                ...
                var artifactProjectItem = VsUtils.GetProjectItemForDocument(EdmxUri.LocalPath, PackageManager.Package);
                ...
                if (VsUtils.IsLinkProjectItem(artifactProjectItem))
                {
                    ...
                    var projectDirectory = VsUtils.GetProjectRoot(project, PackageManager.Package);
