    ...
    internal static class ProgressDialogHelper
    {
            ...
            IWin32Window owner, IList<EntityStoreSchemaFilterEntry> newFunctionEntries, ModelBuilderSettings modelBuilderSettings)
        {
            ...
            using (ProgressDialog pd = new ProgressDialog(
                Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeProgressDialogTitle,
                Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeProgressDialogDescription,
                Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeProgressDialogInitialStatus, GatherAndStoreSchemaProcedureInformation, args))
            {
        ...
        private static object GatherAndStoreSchemaProcedureInformation(BackgroundWorker worker, DoWorkEventArgs e)
        {
            if (null == worker)
            {
                throw new ProgressDialogException(
                    string.Format(
                        CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeErrorMessage, "null BackgroundWorker"));
            }
            ...
            if (e.Argument is not GatherAndReturnSprocInfo arg)
            {
                throw new ProgressDialogException(
                    string.Format(
                        CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeErrorMessage, "null DoWorkEventArgs"));
            }
            ...
            if (null == newFunctionFilterEntries)
            {
                throw new ProgressDialogException(
                    string.Format(
                        CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeErrorMessage, "null newFunctionFilterEntries"));
            }
            ...
            if (null == modelBuilderSettings)
            {
                throw new ProgressDialogException(
                    string.Format(
                        CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeErrorMessage, "null modelBuilderSettings"));
            }
            ...
            int amountOfProgressBarGiven = 100)
        {
            ...
            if (null == dataConnection)
            {
                throw new ProgressDialogException(
                    string.Format(
                        CultureInfo.CurrentCulture, Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeErrorMessage, "null IVsDataConnection"));
            }
                    ...
                    else
                    {
                            ...
                            && worker.WorkerReportsProgress)
                        {
                            ...
                            userState.CurrentStatusMessage = string.Format(
                                ...
                                Microsoft.VisualStudio.Data.Entity.Design.Resources.RetrievingSprocReturnTypeInfoMessage,
                                numFunctionFilterEntryCurrent,
