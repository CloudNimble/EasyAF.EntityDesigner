...
namespace Microsoft.VisualStudio.Data.Entity.Design.Ide
{
    ...
    internal static class ErrorListHelper
    {
        ...
        internal static DesignerErrorList GetSingleDocErrorList(Uri uri)
        {
            ...
            {
                var hierarchy = VsUtils.GetVsHierarchy(currentProject, PackageManager.Package);
                if (hierarchy != null)
                {
                    ...
                    {
                        if (vsFileInfo.Hierarchy == VsUtils.GetVsHierarchy(currentProject, PackageManager.Package))
                        {
        ...
        {
            var serviceProvider = PackageManager.Package;
        ...
        internal static void LogExtensionErrors(IEnumerable<ExtensionError> errors, ProjectItem projectItem)
        {
            ...
            {
                var hierarchy = VsUtils.GetVsHierarchy(projectItem.ContainingProject, PackageManager.Package);
                var itemId = VsUtils.GetProjectItemId(hierarchy, projectItem);
        ...
        internal static void RegisterForNotifications()
        {
            ...
            var IVsSolution = PackageManager.Package.GetSolution();
            ...
            var solutionBuildManager = PackageManager.Package.GetSolutionBuildManager();
        ...
        internal static void UnregisterForNotifications()
        {
            ...
            {
                var IVsRDT = PackageManager.Package.GetRunningDocumentTable();
