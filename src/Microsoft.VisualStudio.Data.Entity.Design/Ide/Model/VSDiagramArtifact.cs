...
namespace Microsoft.VisualStudio.Data.Entity.Design.Ide.Model
{
    internal class VSDiagramArtifact : DiagramArtifact, IVsRunningDocTableEvents2
    {
        ...
        internal override void Init()
        {
            ...
            PackageManager.Package.GetRunningDocumentTable().AdviseRunningDocTableEvents(this, out _rdtCookie);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                PackageManager.Package.GetRunningDocumentTable().UnadviseRunningDocTableEvents(_rdtCookie);
            }
