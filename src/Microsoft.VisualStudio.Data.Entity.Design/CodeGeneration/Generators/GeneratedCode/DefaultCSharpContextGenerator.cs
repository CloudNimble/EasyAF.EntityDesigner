...
{
    object value = this.Session["ContextClassName"];
    if (typeof(string).IsInstanceOfType(value))
    {
        this._ContextClassNameField = ((string)(value));
    ...
    else
    {
        if ((value != null))
        {
            ...
            if (((tc != null) 
                        && tc.CanConvertFrom(value.GetType())))
            {
                this._ContextClassNameField = ((string)(tc.ConvertFrom(value)));
                ContextClassNameValueAcquired = true;
            }
            else
            {
                this.Error("The type \'System.String\' of the parameter \'ContextClassName\' did not match the ty" +
...
{
    object value = this.Session["ConnectionStringName"];
    if (typeof(string).IsInstanceOfType(value))
    {
        this._ConnectionStringNameField = ((string)(value));
    ...
    else
    {
        if ((value != null))
        {
            ...
            if (((tc != null) 
                        && tc.CanConvertFrom(value.GetType())))
            {
                this._ConnectionStringNameField = ((string)(tc.ConvertFrom(value)));
                ConnectionStringNameValueAcquired = true;
            }
            else
            {
                this.Error("The type \'System.String\' of the parameter \'ConnectionStringName\' did not match th" +
